...
/* templates */
%template(SMESH_SequenceOfNode) NCollection_Sequence <SMDS_MeshNodePtr>;
%template(SMESH_SequenceOfElemPtr) NCollection_Sequence <SMDS_MeshElementPtr>;
%template(SMESH_OctreeNodeIterator) SMDS_Iterator <SMESH_OctreeNode *>;
%template(SMESH_IndexedMapOfShape) NCollection_IndexedMap <TopoDS_Shape>;
%template(SMESH_IndexedDataMapOfShapeIndexedMapOfShape) NCollection_IndexedDataMap <SMESH_IndexedMapOfShape , TopoDS_Shape>;
%template(NLink) pair<const SMDS_MeshNode * , const SMDS_MeshNode *>;
