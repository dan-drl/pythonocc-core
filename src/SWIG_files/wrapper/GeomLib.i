...
") GeomLib_CheckCurveOnSurface;
	...
	:rtype: None
") GeomLib_CheckCurveOnSurface;
		 GeomLib_CheckCurveOnSurface (const Handle_Geom_Curve & theCurve,const Handle_Geom_Surface & theSurface,const Standard_Real theFirst,const Standard_Real theLast,const Standard_Real theTolRange = Precision::Confusion());
	...
	:rtype: None
") Init;
		void Init (const Handle_Geom_Curve & theCurve,const Handle_Geom_Surface & theSurface,const Standard_Real theFirst,const Standard_Real theLast,const Standard_Real theTolRange = Precision::Confusion());
		%feature("compactdefaultargs") Init;
