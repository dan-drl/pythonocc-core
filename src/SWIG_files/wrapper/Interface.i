...
%extend NCollection_Array1 <Handle_TCollection_HAsciiString> {
    %pythoncode {
    def __getitem__(self, index):
        if index + self.Lower() > self.Upper():
            raise IndexError("index out of range")
...
") AddCategory;
	...
	:rtype: int
") CatNum;
		Standard_Integer CatNum (const Handle_Standard_Transient & theEnt,const Interface_ShareTool & theShares);
...
") ClearNums;
	...
	:rtype: None
") Compute;
		void Compute (const Handle_Interface_InterfaceModel & theModel,const Interface_ShareTool & theShares);
		%feature("compactdefaultargs") Init;
...
") Interface_Category;
	...
	:param theProtocol:
	:type theProtocol: Handle_Interface_Protocol &
	:rtype: None
") Interface_Category;
		 Interface_Category (const Handle_Interface_Protocol & theProtocol);
		%feature("compactdefaultargs") Interface_Category;
		%feature("autodoc", "	* Creates a Category with a given GTool

	:param theGTool:
	:type theGTool: Handle_Interface_GTool &
	:rtype: None
") Interface_Category;
		 Interface_Category (const Handle_Interface_GTool & theGTool);
...
") Number;
	...
	:rtype: None
") SetProtocol;
		void SetProtocol (const Handle_Interface_Protocol & theProtocol);
};
...
") Interface_STAT;
	...
	:param tit:
	:type tit: Handle_TCollection_HAsciiString &
	:param total:
	:type total: float &
	:param phn:
	:type phn: Handle_TColStd_HSequenceOfAsciiString &
	:param phw:
	:type phw: Handle_TColStd_HSequenceOfReal &
	:param phdeb:
	:type phdeb: Handle_TColStd_HSequenceOfInteger &
	:param phfin:
	:type phfin: Handle_TColStd_HSequenceOfInteger &
	:param stw:
	:type stw: Handle_TColStd_HSequenceOfReal &
	:rtype: None
") Internals;
		void Internals (Handle_TCollection_HAsciiString & tit,Standard_Real &OutValue,Handle_TColStd_HSequenceOfAsciiString & phn,Handle_TColStd_HSequenceOfReal & phw,Handle_TColStd_HSequenceOfInteger & phdeb,Handle_TColStd_HSequenceOfInteger & phfin,Handle_TColStd_HSequenceOfReal & stw);
