...
%template(TObj_DataMapOfNameLabel) NCollection_DataMap <Handle_TCollection_HExtendedString , TDF_Label>;
%template(TObj_DataMapOfObjectHSequenceOcafObjects) NCollection_DataMap <Handle_TObj_Object , Handle_TObj_HSequenceOfObject>;
%template(TObj_DataMapOfStringPointer) NCollection_DataMap <TCollection_AsciiString , Standard_Address>;
%template(TObj_SequenceOfIterator) NCollection_Sequence <Handle_TObj_ObjectIterator>;
%template(TObj_SequenceOfObject) NCollection_Sequence <Handle_TObj_Object>;
...
typedef NCollection_DataMap <Handle_TCollection_HExtendedString , TDF_Label> TObj_DataMapOfNameLabel;
typedef NCollection_DataMap <Handle_TObj_Object , Handle_TObj_HSequenceOfObject> TObj_DataMapOfObjectHSequenceOcafObjects;
typedef NCollection_DataMap <TCollection_AsciiString , Standard_Address> TObj_DataMapOfStringPointer;
typedef NCollection_Sequence <Handle_TObj_ObjectIterator> TObj_SequenceOfIterator;
typedef NCollection_Sequence <Handle_TObj_Object> TObj_SequenceOfObject;
...
class TObj_Application : public TDocStd_Application {
	...
	:rtype: bool
") CreateNewDocument;
		Standard_Boolean CreateNewDocument (Handle_TDocStd_Document & theDoc,const TCollection_ExtendedString & theFormat);
...
") GetInstance;
		static Handle_TObj_Application GetInstance ();
...
") IsVerbose;
	...
	:param theTargetDoc:
	:type theTargetDoc: Handle_TDocStd_Document &
	:rtype: bool
") LoadDocument;
		virtual Standard_Boolean LoadDocument (const TCollection_ExtendedString & theSourceFile,Handle_TDocStd_Document & theTargetDoc);
...
") ResourcesName;
	...
	:param theSourceDoc:
	:type theSourceDoc: Handle_TDocStd_Document &
	:param theTargetFile:
	:type theTargetFile: TCollection_ExtendedString &
	:rtype: bool
") SaveDocument;
		virtual Standard_Boolean SaveDocument (const Handle_TDocStd_Document & theSourceDoc,const TCollection_ExtendedString & theTargetFile);
...
class TObj_Assistant {
	...
	:param theModel:
	:type theModel: Handle_TObj_Model
	:rtype: void
") BindModel;
		static void BindModel (const Handle_TObj_Model theModel);
	...
	:rtype: int
") BindType;
		static Standard_Integer BindType (const Handle_Standard_Type & theType);
...
") FindModel;
		static Handle_TObj_Model FindModel (const char * theName);
...
") FindType;
		static Handle_Standard_Type FindType (const Standard_Integer theTypeIndex);
	...
	:rtype: int
") FindTypeIndex;
		static Standard_Integer FindTypeIndex (const Handle_Standard_Type & theType);
...
") GetAppVersion;
	...
	:rtype: Handle_TObj_Model
") GetCurrentModel;
		static Handle_TObj_Model GetCurrentModel ();
	...
	:rtype: void
") SetCurrentModel;
		static void SetCurrentModel (const Handle_TObj_Model & theModel);
...
") SetToFix;
	...
	:rtype: None
") TObj_CheckModel;
		 TObj_CheckModel (const Handle_TObj_Model & theModel);
};
...
") Close;
	...
	:rtype: None
") CloseDocument;
		void CloseDocument (const Handle_TDocStd_Document & theDoc);
...
") CommitCommand;
	...
	:param theTarget:
	:type theTarget: Handle_TObj_Model &
	:param theRelocTable:
	:type theRelocTable: Handle_TDF_RelocationTable &
	:rtype: None
") CopyReferences;
		void CopyReferences (const Handle_TObj_Model & theTarget,const Handle_TDF_RelocationTable & theRelocTable);
		%feature("compactdefaultargs") FindObject;
		%feature("autodoc", "	* Returns an Object by given Name (or Null if not found).

	:param theName:
	:type theName: Handle_TCollection_HExtendedString &
	:param theDictionary:
	:type theDictionary: Handle_TObj_TNameContainer &
	:rtype: Handle_TObj_Object
") FindObject;
		Handle_TObj_Object FindObject (const Handle_TCollection_HExtendedString & theName,const Handle_TObj_TNameContainer & theDictionary);
	...
	:rtype: Handle_TObj_Application
") GetApplication;
		const Handle_TObj_Application GetApplication ();
...
") GetChecker;
		Handle_TObj_CheckModel GetChecker ();
...
") GetChildren;
		Handle_TObj_ObjectIterator GetChildren ();
...
") GetDictionary;
		Handle_TObj_TNameContainer GetDictionary ();
...
") GetDocument;
	...
	:rtype: Handle_TObj_Model
") GetDocumentModel;
		static Handle_TObj_Model GetDocumentModel (const TDF_Label & theLabel);
...
") GetFile;
		Handle_TCollection_HExtendedString GetFile ();
...
") GetMainPartition;
		Handle_TObj_Partition GetMainPartition ();
	...
	:rtype: Handle_TCollection_HExtendedString
") GetModelName;
		Handle_TCollection_HExtendedString GetModelName ();
...
") IsModified;
	...
	:rtype: bool
") IsRegisteredName;
		Standard_Boolean IsRegisteredName (const Handle_TCollection_HExtendedString & theName,const Handle_TObj_TNameContainer & theDictionary);
...
") OpenCommand;
	...
	:rtype: bool
") Paste;
		Standard_Boolean Paste (Handle_TObj_Model theModel,Handle_TDF_RelocationTable theRelocTable = 0);
	...
	:rtype: None
") RegisterName;
		void RegisterName (const Handle_TCollection_HExtendedString & theName,const TDF_Label & theLabel,const Handle_TObj_TNameContainer & theDictionary);
...
") SetModified;
	...
	:param theObject:
	:type theObject: Handle_TObj_Object &
	:rtype: void
") SetNewName;
		static void SetNewName (const Handle_TObj_Object & theObject);
	...
	:rtype: None
") UnRegisterName;
		void UnRegisterName (const Handle_TCollection_HExtendedString & theName,const Handle_TObj_TNameContainer & theDictionary);
...
/* end public enums declaration */
	...
	:rtype: None
") AddBackReference;
		void AddBackReference (const Handle_TObj_Object & theObject);
...
") CanDetach;
	...
	:rtype: bool
") CanRemoveReference;
		Standard_Boolean CanRemoveReference (const Handle_TObj_Object & theObject);
...
") ClearFlags;
	...
	:rtype: Handle_TObj_Object
") Clone;
		Handle_TObj_Object Clone (const TDF_Label & theTargetLabel,Handle_TDF_RelocationTable theRelocTable = 0);
	...
	:rtype: None
") CopyChildren;
		void CopyChildren (TDF_Label & theTargetLabel,const Handle_TDF_RelocationTable & theRelocTable);
		%feature("compactdefaultargs") CopyReferences;
		%feature("autodoc", "	* Coping the references. return Standard_False is Target object is different type

	:param theTargetObject:
	:type theTargetObject: Handle_TObj_Object &
	:param theRelocTable:
	:type theRelocTable: Handle_TDF_RelocationTable &
	:rtype: None
") CopyReferences;
		void CopyReferences (const Handle_TObj_Object & theTargetObject,const Handle_TDF_RelocationTable & theRelocTable);
...
") Detach;
	...
	:rtype: Handle_TObj_ObjectIterator
") GetBackReferences;
		Handle_TObj_ObjectIterator GetBackReferences (const Handle_Standard_Type & theType = NULL);
...
") GetChildLabel;
	...
	:rtype: Handle_TObj_ObjectIterator
") GetChildren;
		Handle_TObj_ObjectIterator GetChildren (const Handle_Standard_Type & theType = NULL);
...
") GetDictionary;
	...
	:rtype: Handle_TObj_Object
") GetFatherObject;
		Handle_TObj_Object GetFatherObject (const Handle_Standard_Type & theType = NULL);
...
") GetModel;
	...
	:rtype: Handle_TCollection_HExtendedString
") GetName;
		Handle_TCollection_HExtendedString GetName ();
		%feature("compactdefaultargs") GetName;
...
") GetName;
	...
	:param &:
	:type &: Handle_TObj_Object
	:rtype: Handle_TCollection_HExtendedString
") GetNameForClone;
		Handle_TCollection_HExtendedString GetNameForClone (const Handle_TObj_Object &);
	...
	:type theLabel: TDF_Label &
	:param theResult:
	:type theResult: Handle_TObj_Object &
	:param isSuper: default value is Standard_False
	:type isSuper: bool
	:rtype: bool
") GetObj;
		static Standard_Boolean GetObj (const TDF_Label & theLabel,Handle_TObj_Object & theResult,const Standard_Boolean isSuper = Standard_False);
...
") GetReferenceLabel;
	...
	:rtype: Handle_TObj_ObjectIterator
") GetReferences;
		Handle_TObj_ObjectIterator GetReferences (const Handle_Standard_Type & theType = NULL);
...
") HasBackReferences;
	...
	:rtype: bool
") HasReference;
		Standard_Boolean HasReference (const Handle_TObj_Object & theObject);
...
") RemoveAllReferences;
	...
	:rtype: None
") RemoveBackReference;
		void RemoveBackReference (const Handle_TObj_Object & theObject,const Standard_Boolean theSingleOnly = Standard_True);
...
") RemoveBackReferences;
	...
	:rtype: None
") RemoveReference;
		void RemoveReference (const Handle_TObj_Object & theObject);
	...
	:param theOldObject:
	:type theOldObject: Handle_TObj_Object &
	:param theNewObject:
	:type theNewObject: Handle_TObj_Object &
	:rtype: None
") ReplaceReference;
		void ReplaceReference (const Handle_TObj_Object & theOldObject,const Handle_TObj_Object & theNewObject);
...
") SetFlags;
	...
	:rtype: bool
") SetName;
		Standard_Boolean SetName (const Handle_TCollection_HExtendedString & theName);
		%feature("compactdefaultargs") SetName;
		%feature("autodoc", "	* Sets name of the object. Returns False if theName is not unique.
	...
	:rtype: bool
") SetName;
		Standard_Boolean SetName (const Handle_TCollection_HAsciiString & theName);
		%feature("compactdefaultargs") SetName;
		%feature("autodoc", "	* Sets name of the object. Returns False if theName is not unique.
...
class TObj_Persistence {
	...
	:rtype: Handle_TObj_Object
") CreateNewObject;
		static Handle_TObj_Object CreateNewObject (const char * theType,const TDF_Label & theLabel);
...
typedef TObj_TIntSparseArray_VecOfData::ConstIterator Iterator;
	...
	:param theDelta:
	:type theDelta: Handle_TDF_AttributeDelta &
	:param toForce:
	:type toForce: bool
	:rtype: bool
") AfterUndo;
		Standard_Boolean AfterUndo (const Handle_TDF_AttributeDelta & theDelta,const Standard_Boolean toForce);
...
") ClearDelta;
	...
	:param theDelta:
	:type theDelta: Handle_TDF_DeltaOnModification &
	:rtype: None
") DeltaOnModification;
		void DeltaOnModification (const Handle_TDF_DeltaOnModification & theDelta);
...
") NewEmpty;
	...
	:param theInto:
	:type theInto: Handle_TDF_Attribute &
	:param theRT:
	:type theRT: Handle_TDF_RelocationTable &
	:rtype: None
") Paste;
		void Paste (const Handle_TDF_Attribute & theInto,const Handle_TDF_RelocationTable & theRT);
		%feature("compactdefaultargs") Restore;
		%feature("autodoc", "	* Restores the set using info saved in backup attribute theDelta.

	:param theDelta:
	:type theDelta: Handle_TDF_Attribute &
	:rtype: None
") Restore;
		void Restore (const Handle_TDF_Attribute & theDelta);
...
") Set;
		static Handle_TObj_TIntSparseArray Set (const TDF_Label & theLabel);
...
") Paste;
	...
	:param theWith:
	:type theWith: Handle_TDF_Attribute &
	:rtype: None
") Restore;
		void Restore (const Handle_TDF_Attribute & theWith);
		%feature("compactdefaultargs") Set;
	...
	:rtype: None
") Set;
		void Set (const Handle_TObj_Model & theModel);
...
") ID;
	...
	:rtype: bool
") IsRegistered;
		Standard_Boolean IsRegistered (const Handle_TCollection_HExtendedString & theName);
		%feature("compactdefaultargs") NewEmpty;
...
") Paste;
	...
	:rtype: None
") RecordName;
		void RecordName (const Handle_TCollection_HExtendedString & theName,const TDF_Label & theLabel);
	...
	:rtype: None
") RemoveName;
		void RemoveName (const Handle_TCollection_HExtendedString & theName);
		%feature("compactdefaultargs") Restore;
		%feature("autodoc", "	* Restores the backuped contents from <theWith> into this one. It is used when aborting a transaction.
...
") Restore;
	...
	:rtype: Handle_TObj_TNameContainer
") Set;
		static Handle_TObj_TNameContainer Set (const TDF_Label & theLabel);
		%feature("compactdefaultargs") Set;
...
class TObj_TObject : public TDF_Attribute {
	...
	:rtype: bool
") AfterUndo;
		Standard_Boolean AfterUndo (const Handle_TDF_AttributeDelta & anAttDelta,const Standard_Boolean forceIt);
...
") Restore;
	...
	:type theLabel: TDF_Label &
	:param theElem:
	:type theElem: Handle_TObj_Object &
	:rtype: Handle_TObj_TObject
") Set;
		static Handle_TObj_TObject Set (const TDF_Label & theLabel,const Handle_TObj_Object & theElem);
		%feature("compactdefaultargs") Set;
	...
	:rtype: None
") Set;
		void Set (const Handle_TObj_Object & theElem);
...
") AfterRetrieval;
	...
	:rtype: bool
") AfterUndo;
		Standard_Boolean AfterUndo (const Handle_TDF_AttributeDelta & theDelta,const Standard_Boolean isForced = Standard_False);
		%feature("compactdefaultargs") BeforeForget;
...
") BeforeForget;
	...
	:rtype: bool
") BeforeUndo;
		Standard_Boolean BeforeUndo (const Handle_TDF_AttributeDelta & theDelta,const Standard_Boolean isForced = Standard_False);
		%feature("compactdefaultargs") Get;
...
") Restore;
	...
	:type theObject: Handle_TObj_Object &
	:param theMaster:
	:type theMaster: Handle_TObj_Object &
	:rtype: Handle_TObj_TReference
") Set;
		static Handle_TObj_TReference Set (const TDF_Label & theLabel,const Handle_TObj_Object & theObject,const Handle_TObj_Object & theMaster);
		%feature("compactdefaultargs") Set;
	...
	:rtype: None
") Set;
		void Set (const Handle_TObj_Object & theObject,const TDF_Label & theMasterLabel);
		%feature("compactdefaultargs") Set;
...
") Set;
		static Handle_TObj_TXYZ Set (const TDF_Label & theLabel,const gp_XYZ & theXYZ);
		%feature("compactdefaultargs") Set;
...
") Next;
	...
	:rtype: None
") TObj_ModelIterator;
		 TObj_ModelIterator (const Handle_TObj_Model & theModel);
		%feature("compactdefaultargs") Value;
...
") AfterRetrieval;
	...
	:rtype: Handle_TObj_Partition
") Create;
		static Handle_TObj_Partition Create (const TDF_Label & theLabel);
...
") GetLastIndex;
	...
	:rtype: Handle_TCollection_HExtendedString
") GetNamePrefix;
		Handle_TCollection_HExtendedString GetNamePrefix ();
	...
	:rtype: Handle_TCollection_HExtendedString
") GetNewName;
		Handle_TCollection_HExtendedString GetNewName (const Standard_Boolean theIsToChangeCount = Standard_True);
	...
	:rtype: Handle_TObj_Partition
") GetPartition;
		static Handle_TObj_Partition GetPartition (const Handle_TObj_Object & theObject);
...
") SetName;
	...
	:param thePrefix:
	:type thePrefix: Handle_TCollection_HExtendedString &
	:rtype: None
") SetNamePrefix;
		void SetNamePrefix (const Handle_TCollection_HExtendedString & thePrefix);
		%feature("compactdefaultargs") Update;
...
") Next;
	...
	:param theObjects:
	:type theObjects: Handle_TObj_HSequenceOfObject &
	:param theType: default value is NULL
	:type theType: Handle_Standard_Type &
	:rtype: None
") TObj_SequenceIterator;
		 TObj_SequenceIterator (const Handle_TObj_HSequenceOfObject & theObjects,const Handle_Standard_Type & theType = NULL);
		%feature("compactdefaultargs") Value;
		%feature("autodoc", "	* Returns the current item
...
") TObj_OcafObjectIterator;
		 TObj_OcafObjectIterator (const TDF_Label & theLabel,const Handle_Standard_Type & theType = NULL,const Standard_Boolean theRecursive = Standard_False);
};
...
") TObj_ReferenceIterator;
		 TObj_ReferenceIterator (const TDF_Label & theLabel,const Handle_Standard_Type & theType = NULL,const Standard_Boolean theRecursive = Standard_True);
};
