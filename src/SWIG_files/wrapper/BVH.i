...
%define Handle_BVH_ObjectTransient Handle(BVH_ObjectTransient)
%enddef
typedef BVH_ObjectTransient  Standard_Transient;
%define Handle_BVH_BuilderTransient Handle(BVH_BuilderTransient)
%enddef
typedef BVH_BuilderTransient  Standard_Transient;
%define Handle_BVH_Properties Handle(BVH_Properties)
%enddef
typedef BVH_Properties  Standard_Transient;
%define Handle_BVH_TreeBaseTransient Handle(BVH_TreeBaseTransient)
%enddef
typedef BVH_TreeBaseTransient  Standard_Transient;
