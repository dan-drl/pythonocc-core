...
%template(TColStd_DataMapOfIntegerTransient) NCollection_DataMap <Standard_Integer , Handle_Standard_Transient , TColStd_MapIntegerHasher>;
...
%template(TColStd_IndexedMapOfTransient) NCollection_IndexedMap <Handle_Standard_Transient , TColStd_MapTransientHasher>;
...
%template(TColStd_MapOfTransient) NCollection_Map <Handle_Standard_Transient , TColStd_MapTransientHasher>;
%template(TColStd_ListOfTransient) NCollection_List <Handle_Standard_Transient>;
%template(TColStd_ListIteratorOfListOfTransient) NCollection_TListIterator<Handle_Standard_Transient>;
%template(TColStd_SequenceOfTransient) NCollection_Sequence <Handle_Standard_Transient>;
...
%template(TColStd_DataMapOfTransientTransient) NCollection_DataMap <Handle_Standard_Transient , Handle_Standard_Transient , TColStd_MapTransientHasher>;
...
%template(TColStd_SequenceOfHExtendedString) NCollection_Sequence <Handle_TCollection_HExtendedString>;
...
%template(TColStd_Array2OfTransient) NCollection_Array2 <Handle_Standard_Transient>;
...
%template(TColStd_MapTransientHasher) NCollection_DefaultHasher <Handle_Standard_Transient>;
%template(TColStd_SequenceOfExtendedString) NCollection_Sequence <TCollection_ExtendedString>;
%template(TColStd_IndexedDataMapOfTransientTransient) NCollection_IndexedDataMap <Handle_Standard_Transient , Handle_Standard_Transient , TColStd_MapTransientHasher>;
%template(TColStd_Array1OfTransient) NCollection_Array1 <Handle_Standard_Transient>;

%extend NCollection_Array1 <Handle_Standard_Transient> {
    %pythoncode {
    def __getitem__(self, index):
        if index + self.Lower() > self.Upper():
            raise IndexError("index out of range")
...
%template(TColStd_SequenceOfHAsciiString) NCollection_Sequence <Handle_TCollection_HAsciiString>;
