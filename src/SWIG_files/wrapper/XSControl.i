...
") ActorWrite;
		...
		%feature("autodoc", "	:rtype: NCollection_DataMap<TCollection_AsciiString, Handle_Standard_Transient>
") AdaptorSession;
		const NCollection_DataMap<TCollection_AsciiString, Handle_Standard_Transient> & AdaptorSession ();
	...
	:rtype: None
") AddSessionItem;
		void AddSessionItem (const Handle_Standard_Transient & theItem,const char * theName,const Standard_Boolean toApply = Standard_False);
...
") SessionItem;
		Handle_Standard_Transient SessionItem (const char * theName);
...
") BeginTransfer;
	...
	:param theEnt:
	:type theEnt: Handle_Standard_Transient &
	:param theLevel: default value is 0
	:type theLevel: int
	:rtype: Interface_CheckIterator
") CheckList;
		Interface_CheckIterator CheckList (const Handle_Standard_Transient & theEnt,const Standard_Integer theLevel = 0);
	...
	:rtype: Handle_TColStd_HSequenceOfTransient
") CheckedList;
		Handle_TColStd_HSequenceOfTransient CheckedList (const Handle_Standard_Transient & theEnt,const Interface_CheckStatus WithCheck = Interface_CheckAny,const Standard_Boolean theResult = Standard_True);
...
") Clear;
	...
	:rtype: bool
") ClearResult;
		Standard_Boolean ClearResult (const Handle_Standard_Transient & theEnt,const Standard_Integer theMode);
	...
	:rtype: NCollection_DataMap<TCollection_AsciiString, Handle_Standard_Transient>
") Context;
		NCollection_DataMap<TCollection_AsciiString, Handle_Standard_Transient> & Context ();
	...
	:param theRes:
	:type theRes: Handle_TopTools_HSequenceOfShape &
	:param theMode: default value is 0
	:type theMode: int
	:rtype: Handle_TColStd_HSequenceOfTransient
") EntitiesFromShapeList;
		Handle_TColStd_HSequenceOfTransient EntitiesFromShapeList (const Handle_TopTools_HSequenceOfShape & theRes,const Standard_Integer theMode = 0);
	...
	:param theRes:
	:type theRes: Handle_Standard_Transient &
	:param theMode: default value is 0
	:type theMode: int
	:rtype: Handle_Standard_Transient
") EntityFromResult;
		Handle_Standard_Transient EntityFromResult (const Handle_Standard_Transient & theRes,const Standard_Integer theMode = 0);
...
") EntityFromShapeResult;
		Handle_Standard_Transient EntityFromShapeResult (const TopoDS_Shape & theRes,const Standard_Integer theMode = 0);
...
") FileName;
	...
	:rtype: char *
") FinalEntityLabel;
		const char * FinalEntityLabel (const Handle_Standard_Transient & theEnt);
	...
	:rtype: int
") FinalEntityNumber;
		Standard_Integer FinalEntityNumber (const Handle_Standard_Transient & theEnt);
...
") FinalResult;
		Handle_Transfer_ResultFromModel FinalResult (const Handle_Standard_Transient & theEnt);
	...
	:param theCtx:
	:type theCtx: Handle_Standard_Transient &
	:rtype: bool
") GetContext;
		Standard_Boolean GetContext (const char * theName,const Handle_Standard_Type & theType,Handle_Standard_Transient & theCtx);
	...
	:rtype: bool
") HasChecks;
		Standard_Boolean HasChecks (const Handle_Standard_Transient & theEnt,const Standard_Boolean FailsOnly);
	...
	:rtype: bool
") HasResult;
		Standard_Boolean HasResult (const Handle_Standard_Transient & theEnt);
	...
	:rtype: bool
") IsMarked;
		Standard_Boolean IsMarked (const Handle_Standard_Transient & theEnt);
	...
	:rtype: bool
") IsRecorded;
		Standard_Boolean IsRecorded (const Handle_Standard_Transient & theEnt);
	...
	:rtype: bool
") IsSkipped;
		Standard_Boolean IsSkipped (const Handle_Standard_Transient & theEnt);
...
") LastCheckList;
	...
	:rtype: Handle_TColStd_HSequenceOfTransient
") LastTransferList;
		Handle_TColStd_HSequenceOfTransient LastTransferList (const Standard_Boolean theRoots);
		%feature("compactdefaultargs") Model;
...
") PrintStats;
	...
	:param theTP:
	:type theTP: Handle_Transfer_TransientProcess &
	:param theList:
	:type theList: Handle_TColStd_HSequenceOfTransient &
	:param theWhat:
	:type theWhat: int
	:param theMode: default value is 0
	:type theMode: int
	:rtype: void
") PrintStatsOnList;
		static void PrintStatsOnList (const Handle_Transfer_TransientProcess & theTP,const Handle_TColStd_HSequenceOfTransient & theList,const Standard_Integer theWhat,const Standard_Integer theMode = 0);
	...
	:rtype: void
") PrintStatsProcess;
		static void PrintStatsProcess (const Handle_Transfer_TransientProcess & theTP,const Standard_Integer theWhat,const Standard_Integer theMode = 0);
	...
	:rtype: bool
") Recognize;
		Standard_Boolean Recognize (const Handle_Standard_Transient & theEnt);
	...
	:rtype: bool
") RecordResult;
		Standard_Boolean RecordResult (const Handle_Standard_Transient & theEnt);
...
") RecordedList;
	...
	:rtype: Handle_Transfer_ResultFromModel
") ResultFromNumber;
		Handle_Transfer_ResultFromModel ResultFromNumber (const Standard_Integer theNum);
		%feature("compactdefaultargs") SetActor;
		%feature("autodoc", "	* Sets the Actor directly : this value will be used if the Controller is not set

	:param theActor:
	:type theActor: Handle_Transfer_ActorOfTransientProcess &
	:rtype: None
") SetActor;
		void SetActor (const Handle_Transfer_ActorOfTransientProcess & theActor);
	...
	:rtype: None
") SetContext;
		void SetContext (const char * theName,const Handle_Standard_Transient & theCtx);
	...
	:param theControl:
	:type theControl: Handle_XSControl_Controller &
	:rtype: None
") SetController;
		void SetController (const Handle_XSControl_Controller & theControl);
...
") SetFileName;
	...
	:param theGraph:
	:type theGraph: Handle_Interface_HGraph &
	:rtype: None
") SetGraph;
		void SetGraph (const Handle_Interface_HGraph & theGraph);
	...
	:param theModel:
	:type theModel: Handle_Interface_InterfaceModel &
	:rtype: None
") SetModel;
		void SetModel (const Handle_Interface_InterfaceModel & theModel);
	...
	:rtype: None
") SetTransientProcess;
		void SetTransientProcess (const Handle_Transfer_TransientProcess & theTP);
	...
	:rtype: TopoDS_Shape
") ShapeResult;
		TopoDS_Shape ShapeResult (const Handle_Standard_Transient & theEnt);
...
") ShapeResultList;
		Handle_TopTools_HSequenceOfShape ShapeResultList (const Standard_Boolean theRec);
	...
	:rtype: bool
") Skip;
		Standard_Boolean Skip (const Handle_Standard_Transient & theEnt);
	...
	:rtype: None
") TransferClear;
		void TransferClear (const Handle_Standard_Transient & theEnt,const Standard_Integer theLevel = 0);
		%feature("compactdefaultargs") TransferList;
	...
	:rtype: int
") TransferList;
		Standard_Integer TransferList (const Handle_TColStd_HSequenceOfTransient & theList,const Standard_Boolean theRec = Standard_True);
		%feature("compactdefaultargs") TransferOne;
	...
	:rtype: int
") TransferOne;
		Standard_Integer TransferOne (const Handle_Standard_Transient & theEnt,const Standard_Boolean theRec = Standard_True);
		%feature("compactdefaultargs") TransferRoots;
...
") TransientProcess;
	...
	:rtype: Handle_Standard_Transient
") TransientResult;
		Handle_Standard_Transient TransientResult (const Handle_Standard_Transient & theEnt);
...
") RecognizeShape;
	...
	:param theObj:
	:type theObj: Handle_Standard_Transient &
	:rtype: bool
") RecognizeTransient;
		Standard_Boolean RecognizeTransient (const Handle_Standard_Transient & theObj);
	...
	:rtype: Interface_CheckIterator
") ResultCheckList;
		Interface_CheckIterator ResultCheckList (const Handle_Interface_InterfaceModel & theModel);
		%feature("compactdefaultargs") SetController;
		%feature("autodoc", "	* Sets a new Controller, also sets a new FinderProcess

	:param theCtl:
	:type theCtl: Handle_XSControl_Controller &
	:rtype: None
") SetController;
		void SetController (const Handle_XSControl_Controller & theCtl);
		%feature("compactdefaultargs") SetFinderProcess;
		%feature("autodoc", "	* Sets a new FinderProcess and forgets the former one

	:param theFP:
	:type theFP: Handle_Transfer_FinderProcess &
	:rtype: None
") SetFinderProcess;
		void SetFinderProcess (const Handle_Transfer_FinderProcess & theFP);
...
") TransferMode;
	...
	:rtype: IFSelect_ReturnStatus
") TransferWriteShape;
		IFSelect_ReturnStatus TransferWriteShape (const Handle_Interface_InterfaceModel & theModel,const TopoDS_Shape & theShape);
		%feature("compactdefaultargs") TransferWriteTransient;
	...
	:rtype: IFSelect_ReturnStatus
") TransferWriteTransient;
		IFSelect_ReturnStatus TransferWriteTransient (const Handle_Interface_InterfaceModel & theModel,const Handle_Standard_Transient & theObj);
...
") ClearData;
	...
	:rtype: NCollection_DataMap<TCollection_AsciiString, Handle_Standard_Transient>
") Context;
		const NCollection_DataMap<TCollection_AsciiString, Handle_Standard_Transient> & Context ();
...
") NormAdaptor;
	...
	:type theWri: bool
	:param theS:
	:type theS: Handle_Message_Messenger &
	:rtype: bool
") PrintTransferStatus;
		Standard_Boolean PrintTransferStatus (const Standard_Integer theNum,const Standard_Boolean theWri,const Handle_Message_Messenger & theS);
	...
	:rtype: Handle_Standard_Transient
") Result;
		Handle_Standard_Transient Result (const Handle_Standard_Transient & theEnt,const Standard_Integer theMode);
...
") SelectedNorm;
	...
	:param theContext:
	:type theContext: NCollection_DataMap<TCollection_AsciiString, Handle_Standard_Transient> &
	:rtype: None
") SetAllContext;
		void SetAllContext (const NCollection_DataMap<TCollection_AsciiString, Handle_Standard_Transient> & theContext);
		%feature("compactdefaultargs") SetController;
...
") SetController;
	...
	:rtype: bool
") SetMapReader;
		Standard_Boolean SetMapReader (const Handle_Transfer_TransientProcess & theTP);
	...
	:rtype: bool
") SetMapWriter;
		Standard_Boolean SetMapWriter (const Handle_Transfer_FinderProcess & theFP);
		%feature("compactdefaultargs") SetTransferReader;
		%feature("autodoc", "	* Sets a Transfer Reader, which manages transfers on reading

	:param theTR:
	:type theTR: Handle_XSControl_TransferReader &
	:rtype: None
") SetTransferReader;
		void SetTransferReader (const Handle_XSControl_TransferReader & theTR);
		%feature("compactdefaultargs") SetVars;
		%feature("autodoc", "	:param theVars:
	:type theVars: Handle_XSControl_Vars &
	:rtype: None
") SetVars;
		void SetVars (const Handle_XSControl_Vars & theVars);
	...
	:param theEnts:
	:type theEnts: Handle_Standard_Transient &
	:rtype: int
") TransferReadOne;
		Standard_Integer TransferReadOne (const Handle_Standard_Transient & theEnts);
