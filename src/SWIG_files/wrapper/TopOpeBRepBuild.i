...
%template(TopOpeBRepBuild_ListOfPave) NCollection_List <Handle_TopOpeBRepBuild_Pave>;
%template(TopOpeBRepBuild_ListIteratorOfListOfPave) NCollection_TListIterator<Handle_TopOpeBRepBuild_Pave>;
...
%template(TopOpeBRepBuild_ListOfLoop) NCollection_List <Handle_TopOpeBRepBuild_Loop>;
%template(TopOpeBRepBuild_ListIteratorOfListOfLoop) NCollection_TListIterator<Handle_TopOpeBRepBuild_Loop>;
...
") Loop;
		virtual Handle_TopOpeBRepBuild_Loop Loop ();
		%feature("compactdefaultargs") MoreLoop;
		%feature("autodoc", "	:rtype: bool
") MoreLoop;
