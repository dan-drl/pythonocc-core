...
/* templates */
%template(Transfer_TransferMapOfProcessForTransient) NCollection_IndexedDataMap <Handle_Standard_Transient , Handle_Transfer_Binder , TColStd_MapTransientHasher>;
%template(Transfer_SequenceOfBinder) NCollection_Sequence <Handle_Transfer_Binder>;
%template(Transfer_SequenceOfFinder) NCollection_Sequence <Handle_Transfer_Finder>;
%template(Transfer_TransferMapOfProcessForFinder) NCollection_IndexedDataMap <Handle_Transfer_Finder , Handle_Transfer_Binder , Transfer_FindHasher>;
/* end templates declaration */


/* typedefs */
typedef NCollection_IndexedDataMap <Handle_Standard_Transient , Handle_Transfer_Binder , TColStd_MapTransientHasher> Transfer_TransferMapOfProcessForTransient;
typedef NCollection_Sequence <Handle_Transfer_Binder> Transfer_SequenceOfBinder;
typedef NCollection_Sequence <Handle_Transfer_Finder> Transfer_SequenceOfFinder;
typedef NCollection_IndexedDataMap <Handle_Transfer_Finder , Handle_Transfer_Binder , Transfer_FindHasher> Transfer_TransferMapOfProcessForFinder;
...
") AttrList;
		NCollection_DataMap<TCollection_AsciiString, Handle_Standard_Transient> & AttrList ();
