...
%wrap_handle(StepData_DescrGeneral)
%wrap_handle(StepData_DescrReadWrite)
...
%wrap_handle(StepData_DescrProtocol)
...
class StepData {
	...
	:param headerproto:
	:type headerproto: Handle_StepData_Protocol &
	:rtype: void
") AddHeaderProtocol;
...
") As;
		virtual Handle_StepData_Simple As (const char * steptype);
...
") NewEntity;
		virtual Handle_StepData_Described NewEntity ();
};
...
") Entity;
		Handle_Standard_Transient Entity (const Standard_Integer n1 = 1,const Standard_Integer n2 = 1);
...
") SetReal;
	...
	:param val:
	:type val: Handle_StepData_SelectMember &
	:rtype: None
") SetSelectMember;
...
") Transient;
		Handle_Standard_Transient Transient ();
};
...
class StepData_FileRecognizer : public Standard_Transient {
	...
	:param reco:
	:type reco: Handle_StepData_FileRecognizer &
	:rtype: None
") Add;
...
class StepData_GeneralModule : public Interface_GeneralModule {
	...
	:rtype: void
") CheckCase;
		virtual void CheckCase (const Standard_Integer casenum,const Handle_Standard_Transient & ent,const Interface_ShareTool & shares,Handle_Interface_Check & ach);
	...
	:rtype: void
") CopyCase;
		virtual void CopyCase (const Standard_Integer casenum,const Handle_Standard_Transient & entfrom,const Handle_Standard_Transient & entto,Interface_CopyTool & TC);
	...
	:rtype: void
") FillSharedCase;
		virtual void FillSharedCase (const Standard_Integer casenum,const Handle_Standard_Transient & ent,Interface_EntityIterator & iter);
};
...
class StepData_GlobalNodeOfWriterLib : public Standard_Transient {
	...
	:param amodule:
	:type amodule: Handle_StepData_ReadWriteModule &
	:param aprotocol:
	:type aprotocol: Handle_StepData_Protocol &
	:rtype: None
") Add;
...
") Module;
		Handle_StepData_ReadWriteModule Module ();
...
") Next;
		Handle_StepData_GlobalNodeOfWriterLib Next ();
		%feature("compactdefaultargs") Protocol;
...
class StepData_HeaderTool {
	public:
		...
		%feature("autodoc", "	* Fills a FileProtocol with the list of Protocols attached to the list of Schema Names. It can remain empty ...

	:param protocol:
	:type protocol: Handle_StepData_FileProtocol &
	:rtype: None
") Build;
		void Build (const Handle_StepData_FileProtocol & protocol);
		%feature("compactdefaultargs") Ignored;
		%feature("autodoc", "	* Returns an ignored SchemaName, given its rank in the list of Ignored SchemaNames (not in the total list)

	:param num:
	:type num: int
	:rtype: TCollection_AsciiString
") Ignored;
		const TCollection_AsciiString & Ignored (const Standard_Integer num);
		%feature("compactdefaultargs") IsDone;
		%feature("autodoc", "	* Returns True if either Build or Protocol has been called If it is False, Ignored and NbIgnored should not be called

	:rtype: bool
") IsDone;
		Standard_Boolean IsDone ();
		%feature("compactdefaultargs") NamedProtocol;
		%feature("autodoc", "	* Returns the Protocol which corresponds to a Schema Name Returns a Null Handle if this Schema Name is attached to no Protocol recorded in the Global List of ReaderLib

	:param name:
	:type name: TCollection_AsciiString &
	:rtype: Handle_StepData_Protocol
") NamedProtocol;
		Handle_StepData_Protocol NamedProtocol (const TCollection_AsciiString & name);
		%feature("compactdefaultargs") NbIgnoreds;
		%feature("autodoc", "	* Returns the count of ignored SchemaNames (0 if all were OK)

	:rtype: int
") NbIgnoreds;
		Standard_Integer NbIgnoreds ();
		%feature("compactdefaultargs") NbSchemaNames;
		%feature("autodoc", "	* Returns the count of SchemaNames

	:rtype: int
") NbSchemaNames;
		Standard_Integer NbSchemaNames ();
        ...
        %extend{
            ...
            return s.str();}
        		...
        		%feature("compactdefaultargs") Protocol;
		%feature("autodoc", "	* Returns a Protocol computed from the list of Schema Names : - a Null Handle if no SchemaName has been recognized (or list empty) - a single Protocol if only one SchemaName has been recognized - a FileProtocol with its componants if several SchemaNames have been recognized

	:rtype: Handle_StepData_Protocol
") Protocol;
		Handle_StepData_Protocol Protocol ();
		%feature("compactdefaultargs") SchemaName;
		%feature("autodoc", "	* Returns a SchemaName, given its rank

	:param num:
	:type num: int
	:rtype: TCollection_AsciiString
") SchemaName;
		const TCollection_AsciiString & SchemaName (const Standard_Integer num);
		%feature("compactdefaultargs") StepData_HeaderTool;
		%feature("autodoc", "	* Creates a HeaderTool from data read from a File. Computes the list of Schema Names. The Protocol will be computed later (because there are several options)
...
") StepData_HeaderTool;
		...
		%feature("compactdefaultargs") StepData_HeaderTool;
		%feature("autodoc", "	* Creates a HeaderTool directly from a list of Schema Names
...
class StepData_NodeOfWriterLib : public Standard_Transient {
	...
	:param anode:
	:type anode: Handle_StepData_GlobalNodeOfWriterLib &
	:rtype: None
") AddNode;
...
") Next;
		Handle_StepData_NodeOfWriterLib Next ();
		%feature("compactdefaultargs") Protocol;
...
") AddEnumDef;
	...
	:param member:
	:type member: Handle_StepData_PDescr &
	:rtype: None
") AddMember;
...
") Arity;
	...
	:rtype: void
") Check;
		virtual void Check (const StepData_Field & afild,Handle_Interface_Check & ach);
...
") IsDerived;
	...
	:param descr:
	:type descr: Handle_StepData_EDescr &
	:rtype: bool
") IsDescr;
		Standard_Boolean IsDescr (const Handle_StepData_EDescr & descr);
...
") IsString;
	...
	:rtype: bool
") IsType;
		Standard_Boolean IsType (const Handle_Standard_Type & atype);
...
") Member;
		Handle_StepData_PDescr Member (const char * name);
...
") SetField;
	...
	:param other:
	:type other: Handle_StepData_PDescr &
	:rtype: None
") SetFrom;
...
class StepData_Protocol : public Interface_Protocol {
	...
	:param esdescr:
	:type esdescr: Handle_StepData_ESDescr &
	:rtype: None
") AddBasicDescr;
		void AddBasicDescr (const Handle_StepData_ESDescr & esdescr);
	...
	:param adescr:
	:type adescr: Handle_StepData_EDescr &
	:param CN:
	:type CN: int
	:rtype: None
") AddDescr;
		void AddDescr (const Handle_StepData_EDescr & adescr,const Standard_Integer CN);
		%feature("compactdefaultargs") AddPDescr;
		%feature("autodoc", "	* Records an PDescr

	:param pdescr:
	:type pdescr: Handle_StepData_PDescr &
	:rtype: None
") AddPDescr;
		void AddPDescr (const Handle_StepData_PDescr & pdescr);
	...
	:rtype: Handle_StepData_EDescr
") BasicDescr;
		Handle_StepData_EDescr BasicDescr (const char * name,const Standard_Boolean anylevel = Standard_True);
...
") CaseNumber;
	...
	:rtype: Handle_StepData_EDescr
") Descr;
		Handle_StepData_EDescr Descr (const Standard_Integer num);
		%feature("compactdefaultargs") Descr;
	...
	:rtype: Handle_StepData_EDescr
") Descr;
		Handle_StepData_EDescr Descr (const char * name,const Standard_Boolean anylevel = Standard_True);
	...
	:rtype: int
") DescrNumber;
		virtual Standard_Integer DescrNumber (const Handle_StepData_EDescr & adescr);
...
") ECDescr;
		Handle_StepData_ECDescr ECDescr (const TColStd_SequenceOfAsciiString & names,const Standard_Boolean anylevel = Standard_True);
...
") ESDescr;
		Handle_StepData_ESDescr ESDescr (const char * name,const Standard_Boolean anylevel = Standard_True);
...
") HasDescr;
	...
	:rtype: bool
") IsSuitableModel;
		Standard_Boolean IsSuitableModel (const Handle_Interface_InterfaceModel & model);
	...
	:rtype: bool
") IsUnknownEntity;
		Standard_Boolean IsUnknownEntity (const Handle_Standard_Transient & ent);
...
") NewModel;
	...
	:rtype: Handle_StepData_PDescr
") PDescr;
		Handle_StepData_PDescr PDescr (const char * name,const Standard_Boolean anylevel = Standard_True);
...
") Resource;
		Handle_Interface_Protocol Resource (const Standard_Integer num);
		%feature("compactdefaultargs") SchemaName;
...
") StepData_Protocol;
	...
	:rtype: int
") TypeNumber;
		Standard_Integer TypeNumber (const Handle_Standard_Type & atype);
...
class StepData_ReadWriteModule : public Interface_ReaderModule {
	...
	:rtype: int
") CaseNum;
		Standard_Integer CaseNum (const Handle_Interface_FileReaderData & data,const Standard_Integer num);
...
") IsComplex;
	...
	:rtype: None
") Read;
		void Read (const Standard_Integer CN,const Handle_Interface_FileReaderData & data,const Standard_Integer num,Handle_Interface_Check & ach,const Handle_Standard_Transient & ent);
	...
	:rtype: void
") ReadStep;
		virtual void ReadStep (const Standard_Integer CN,const Handle_StepData_StepReaderData & data,const Standard_Integer num,Handle_Interface_Check & ach,const Handle_Standard_Transient & ent);
...
") StepType;
	...
	:rtype: void
") WriteStep;
		virtual void WriteStep (const Standard_Integer CN,StepData_StepWriter & SW,const Handle_Standard_Transient & ent);
};
...
") CaseNumber;
	...
	:rtype: Handle_StepData_PDescr
") Description;
		virtual Handle_StepData_PDescr Description ();
		%feature("compactdefaultargs") Int;
		%feature("autodoc", "	* This internal method gives access to a value implemented by an Integer (to read it)
...
") Dump;
	...
	:param protocol:
	:type protocol: Handle_StepData_Protocol &
...
") ClearLabels;
	...
	:rtype: None
") DumpHeader;
		void DumpHeader (const Handle_Message_Messenger & S,const Standard_Integer level = 0);
		%feature("compactdefaultargs") Entity;
...
") Entity;
	...
	:rtype: None
") GetFromAnother;
		void GetFromAnother (const Handle_Interface_InterfaceModel & other);
	...
	:rtype: bool
") HasHeaderEntity;
		Standard_Boolean HasHeaderEntity (const Handle_Standard_Type & atype);
...
") Header;
	...
	:rtype: Handle_Standard_Transient
") HeaderEntity;
		Handle_Standard_Transient HeaderEntity (const Handle_Standard_Type & atype);
...
") NewEmptyModel;
	...
	:rtype: None
") PrintLabel;
		void PrintLabel (const Handle_Standard_Transient & ent,const Handle_Message_Messenger & S);
...
") StringLabel;
		Handle_TCollection_HAsciiString StringLabel (const Handle_Standard_Transient & ent);
...
") CType;
	...
	:rtype: bool
") CheckDerived;
		Standard_Boolean CheckDerived (const Standard_Integer num,const Standard_Integer nump,const char * mess,Handle_Interface_Check & ach,const Standard_Boolean errstat = Standard_False);
	...
	:rtype: bool
") CheckNbParams;
		Standard_Boolean CheckNbParams (const Standard_Integer num,const Standard_Integer nbreq,Handle_Interface_Check & ach,const char * mess = "");
		%feature("compactdefaultargs") ComplexType;
...
") ComplexType;
	...
	:rtype: None
") FailEnumValue;
		void FailEnumValue (const Standard_Integer num,const Standard_Integer nump,const char * mess,Handle_Interface_Check & ach);
...
") GlobalCheck;
		const Handle_Interface_Check GlobalCheck ();
		%feature("compactdefaultargs") IsComplex;
...
") IsComplex;
	...
	:rtype: bool
") NamedForComplex;
		Standard_Boolean NamedForComplex (const char * name,const Standard_Integer num0,Standard_Integer &OutValue,Handle_Interface_Check & ach);
		%feature("compactdefaultargs") NamedForComplex;
	...
	:rtype: bool
") NamedForComplex;
		Standard_Boolean NamedForComplex (const char * theName,const char * theShortName,const Standard_Integer num0,Standard_Integer &OutValue,Handle_Interface_Check & ach);
...
") PrepareHeader;
	...
	:type ach: Handle_Interface_Check &
	:param descr:
	:type descr: Handle_StepData_PDescr &
	:param val:
	:type val: Handle_Standard_Transient &
	:rtype: bool
") ReadAny;
		Standard_Boolean ReadAny (const Standard_Integer num,const Standard_Integer nump,const char * mess,Handle_Interface_Check & ach,const Handle_StepData_PDescr & descr,Handle_Standard_Transient & val);
	...
	:rtype: bool
") ReadBoolean;
		Standard_Boolean ReadBoolean (const Standard_Integer num,const Standard_Integer nump,const char * mess,Handle_Interface_Check & ach,Standard_Boolean &OutValue);
	...
	:rtype: bool
") ReadEnum;
		Standard_Boolean ReadEnum (const Standard_Integer num,const Standard_Integer nump,const char * mess,Handle_Interface_Check & ach,const StepData_EnumTool & enumtool,Standard_Integer &OutValue);
	...
	:rtype: bool
") ReadEnumParam;
		Standard_Boolean ReadEnumParam (const Standard_Integer num,const Standard_Integer nump,const char * mess,Handle_Interface_Check & ach,const char * & text);
	...
	:rtype: bool
") ReadField;
		Standard_Boolean ReadField (const Standard_Integer num,const Standard_Integer nump,const char * mess,Handle_Interface_Check & ach,const Handle_StepData_PDescr & descr,StepData_Field & fild);
	...
	:rtype: bool
") ReadInteger;
		Standard_Boolean ReadInteger (const Standard_Integer num,const Standard_Integer nump,const char * mess,Handle_Interface_Check & ach,Standard_Integer &OutValue);
	...
	:type ach: Handle_Interface_Check &
	:param descr:
	:type descr: Handle_StepData_ESDescr &
	:param list:
	:type list: StepData_FieldList &
	:rtype: bool
") ReadList;
		Standard_Boolean ReadList (const Standard_Integer num,Handle_Interface_Check & ach,const Handle_StepData_ESDescr & descr,StepData_FieldList & list);
	...
	:rtype: bool
") ReadLogical;
		Standard_Boolean ReadLogical (const Standard_Integer num,const Standard_Integer nump,const char * mess,Handle_Interface_Check & ach,StepData_Logical & flag);
	...
	:rtype: bool
") ReadReal;
		Standard_Boolean ReadReal (const Standard_Integer num,const Standard_Integer nump,const char * mess,Handle_Interface_Check & ach,Standard_Real &OutValue);
	...
	:rtype: bool
") ReadString;
		Standard_Boolean ReadString (const Standard_Integer num,const Standard_Integer nump,const char * mess,Handle_Interface_Check & ach,Handle_TCollection_HAsciiString & val);
	...
	:rtype: int
") ReadSub;
		Standard_Integer ReadSub (const Standard_Integer numsub,const char * mess,Handle_Interface_Check & ach,const Handle_StepData_PDescr & descr,Handle_Standard_Transient & val);
	...
	:rtype: bool
") ReadSubList;
		Standard_Boolean ReadSubList (const Standard_Integer num,const Standard_Integer nump,const char * mess,Handle_Interface_Check & ach,Standard_Integer &OutValue,const Standard_Boolean optional = Standard_False,const Standard_Integer lenmin = 0,const Standard_Integer lenmax = 0);
	...
	:rtype: bool
") ReadTypedParam;
		Standard_Boolean ReadTypedParam (const Standard_Integer num,const Standard_Integer nump,const Standard_Boolean mustbetyped,const char * mess,Handle_Interface_Check & ach,Standard_Integer &OutValue,Standard_Integer &OutValue,TCollection_AsciiString & typ);
	...
	:rtype: bool
") ReadXY;
		Standard_Boolean ReadXY (const Standard_Integer num,const Standard_Integer nump,const char * mess,Handle_Interface_Check & ach,Standard_Real &OutValue,Standard_Real &OutValue);
	...
	:rtype: bool
") ReadXYZ;
		Standard_Boolean ReadXYZ (const Standard_Integer num,const Standard_Integer nump,const char * mess,Handle_Interface_Check & ach,Standard_Real &OutValue,Standard_Real &OutValue,Standard_Real &OutValue);
...
class StepData_StepReaderTool : public Interface_FileReaderTool {
	...
	:rtype: bool
") AnalyseRecord;
		Standard_Boolean AnalyseRecord (const Standard_Integer num,const Handle_Standard_Transient & anent,Handle_Interface_Check & acheck);
	...
	:rtype: None
") BeginRead;
		void BeginRead (const Handle_Interface_InterfaceModel & amodel);
...
") Prepare;
	...
	:rtype: None
") Prepare;
		void Prepare (const Handle_StepData_FileRecognizer & reco,const Standard_Boolean optimize = Standard_True);
		%feature("compactdefaultargs") PrepareHeader;
...
") PrepareHeader;
	...
	:rtype: bool
") Recognize;
		Standard_Boolean Recognize (const Standard_Integer num,Handle_Interface_Check & ach,Handle_Standard_Transient & ent);
	...
	:param reader:
	:type reader: Handle_StepData_StepReaderData &
	:param protocol:
	:type protocol: Handle_StepData_Protocol &
	:rtype: None
...
") JoinLast;
	...
	:rtype: Handle_TCollection_HAsciiString
") Line;
		Handle_TCollection_HAsciiString Line (const Standard_Integer num);
...
") Send;
	...
	:param anArr:
	:type anArr: Handle_TColStd_HArray1OfReal &
	:rtype: None
") SendArrReal;
...
") SendLogical;
	...
	:rtype: None
") SendModel;
		void SendModel (const Handle_StepData_Protocol & protocol,const Standard_Boolean headeronly = Standard_False);
...
") Protocol;
	...
	:type obj: Handle_Standard_Transient &
	:param module:
	:type module: Handle_StepData_ReadWriteModule &
	:param CN:
	:type CN: int &
	:rtype: bool
") Select;
		Standard_Boolean Select (const Handle_Standard_Transient & obj,Handle_StepData_ReadWriteModule & module,Standard_Integer &OutValue);
...
class StepData_DefaultGeneral : public StepData_GeneralModule {
	...
	:rtype: None
") CheckCase;
		void CheckCase (const Standard_Integer casenum,const Handle_Standard_Transient & ent,const Interface_ShareTool & shares,Handle_Interface_Check & ach);
		%feature("compactdefaultargs") CopyCase;
	...
	:rtype: None
") CopyCase;
		void CopyCase (const Standard_Integer casenum,const Handle_Standard_Transient & entfrom,const Handle_Standard_Transient & entto,Interface_CopyTool & TC);
		%feature("compactdefaultargs") FillSharedCase;
	...
	:rtype: None
") FillSharedCase;
		void FillSharedCase (const Standard_Integer casenum,const Handle_Standard_Transient & ent,Interface_EntityIterator & iter);
	...
	:rtype: bool
") NewVoid;
		Standard_Boolean NewVoid (const Standard_Integer CN,Handle_Standard_Transient & entto);
...
") NewVoid;
		...
		%feature("compactdefaultargs") StepData_DescrGeneral;
		%feature("autodoc", "	:param proto:
	:type proto: Handle_StepData_Protocol &
	:rtype: None
...
%make_alias(StepData_DescrGeneral)
...
") ReadStep;
		...
		%feature("compactdefaultargs") StepData_DescrReadWrite;
		%feature("autodoc", "	:param proto:
	:type proto: Handle_StepData_Protocol &
	:rtype: None
...
%make_alias(StepData_DescrReadWrite)
...
class StepData_ECDescr : public StepData_EDescr {
	...
	:param member:
	:type member: Handle_StepData_ESDescr &
	:rtype: None
") Add;
...
") Matches;
	...
	:rtype: Handle_StepData_ESDescr
") Member;
		Handle_StepData_ESDescr Member (const Standard_Integer num);
...
") NbMembers;
	...
	:rtype: Handle_StepData_Described
") NewEntity;
		Handle_StepData_Described NewEntity ();
...
") TypeList;
		Handle_TColStd_HSequenceOfAsciiString TypeList ();
};
...
") Base;
	...
	:rtype: Handle_StepData_PDescr
") Field;
		Handle_StepData_PDescr Field (const Standard_Integer num);
		%feature("compactdefaultargs") IsComplex;
...
") IsComplex;
	...
	:param other:
	:type other: Handle_StepData_ESDescr &
	:rtype: bool
") IsSub;
		Standard_Boolean IsSub (const Handle_StepData_ESDescr & other);
		%feature("compactdefaultargs") Matches;
		%feature("autodoc", "	* Tells if a ESDescr matches a step type : exact or super type
...
") Name;
	...
	:rtype: Handle_StepData_PDescr
") NamedField;
		Handle_StepData_PDescr NamedField (const char * name);
		%feature("compactdefaultargs") NbFields;
...
") Rank;
	...
	:param base:
	:type base: Handle_StepData_ESDescr &
	:rtype: None
") SetBase;
...
") SetNbFields;
	...
	:param super:
	:type super: Handle_StepData_ESDescr &
	:rtype: None
") SetSuper;
...
class StepData_Plex : public StepData_Described {
	...
	:param member:
	:type member: Handle_StepData_Simple &
	:rtype: None
") Add;
	...
	:rtype: Handle_StepData_Simple
") As;
		Handle_StepData_Simple As (const char * steptype);
		%feature("compactdefaultargs") CField;
		%feature("autodoc", "	* Returns a Field from its name; read or write
...
") CField;
	...
	:rtype: None
") Check;
		void Check (Handle_Interface_Check & ach);
		%feature("compactdefaultargs") ECDescr;
		%feature("autodoc", "	* Returns the Description as for a Plex

	:rtype: Handle_StepData_ECDescr
") ECDescr;
		Handle_StepData_ECDescr ECDescr ();
		%feature("compactdefaultargs") Field;
		%feature("autodoc", "	* Returns a Field from its name; read-only
...
") Matches;
	...
	:rtype: Handle_StepData_Simple
") Member;
		Handle_StepData_Simple Member (const Standard_Integer num);
		%feature("compactdefaultargs") NbMembers;
...
") Shared;
	...
	:param descr:
	:type descr: Handle_StepData_ECDescr &
	:rtype: None
") StepData_Plex;
...
") Check;
	...
	:rtype: Handle_StepData_ESDescr
") ESDescr;
		Handle_StepData_ESDescr ESDescr ();
		%feature("compactdefaultargs") Field;
		%feature("autodoc", "	* Returns a Field from its name; read-only
...
class StepData_DescrProtocol : public StepData_FileProtocol {
	public:
		%feature("compactdefaultargs") LibRecord;
		%feature("autodoc", "	* Records this Protocol in the service libraries, with a DescrGeneral and a DescrReadWrite Does nothing if the Protocol brings no proper description

	:rtype: None
") LibRecord;
		void LibRecord ();
		%feature("compactdefaultargs") SchemaName;
		%feature("autodoc", "	* Returns the Schema Name attached to each class of Protocol here, returns the SchemaName set by SetSchemaName was C++ : return const

	:rtype: char *
") SchemaName;
		virtual const char * SchemaName ();
		%feature("compactdefaultargs") SetSchemaName;
		%feature("autodoc", "	* Defines a specific Schema Name for this Protocol
...
") SetSchemaName;
		...
		%feature("compactdefaultargs") StepData_DescrProtocol;
		%feature("autodoc", "	:rtype: None
...
%make_alias(StepData_DescrProtocol)
...
") ArrReal;
		Handle_TColStd_HArray1OfReal ArrReal ();
		%feature("compactdefaultargs") Kind;
		%feature("autodoc", "	:rtype: int
") Kind;
		virtual Standard_Integer Kind ();
	...
	:type arr: Handle_TColStd_HArray1OfReal &
	:rtype: None
") SetArrReal;
