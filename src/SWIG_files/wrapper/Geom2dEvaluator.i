...
%include Geom2dEvaluator_headers.i
...
") DN;
	...
	:param theBase:
	:type theBase: Handle_Geom2d_Curve &
	:param theOffset:
	:type theOffset: float
	:rtype: None
") Geom2dEvaluator_OffsetCurve;
		 Geom2dEvaluator_OffsetCurve (const Handle_Geom2d_Curve & theBase,const Standard_Real theOffset);
		%feature("compactdefaultargs") Geom2dEvaluator_OffsetCurve;
		%feature("autodoc", "	* Initialize evaluator by curve adaptor

	:param theBase:
	:type theBase: Handle_Geom2dAdaptor_HCurve &
	:param theOffset:
	:type theOffset: float
	:rtype: None
") Geom2dEvaluator_OffsetCurve;
		 Geom2dEvaluator_OffsetCurve (const Handle_Geom2dAdaptor_HCurve & theBase,const Standard_Real theOffset);
