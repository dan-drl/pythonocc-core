...
/* templates */
%template(IGESData_Array1OfIGESEntity) NCollection_Array1 <Handle_IGESData_IGESEntity>;

%extend NCollection_Array1 <Handle_IGESData_IGESEntity> {
    %pythoncode {
...
/* typedefs */
typedef NCollection_Array1 <Handle_IGESData_IGESEntity> IGESData_Array1OfIGESEntity;
...
") IGESData_BasicEditor;
	...
	:param protocol:
	:type protocol: Handle_IGESData_Protocol &
	:rtype: None
") IGESData_BasicEditor;
...
") IGESVersionName;
	...
	:rtype: None
") Init;
		void Init (const Handle_IGESData_Protocol & protocol);
		%feature("compactdefaultargs") Init;
	...
	:rtype: None
") Init;
		void Init (const Handle_IGESData_IGESModel & model,const Handle_IGESData_Protocol & protocol);
...
") BlankStatusRequired;
	...
	:rtype: None
") Check;
		void Check (Handle_Interface_Check & ach,const Handle_IGESData_IGESEntity & ent);
	...
	:rtype: None
") CheckTypeAndForm;
		void CheckTypeAndForm (Handle_Interface_Check & ach,const Handle_IGESData_IGESEntity & ent);
...
") Color;
	...
	:rtype: bool
") Correct;
		Standard_Boolean Correct (const Handle_IGESData_IGESEntity & ent);
...
class IGESData_FileRecognizer : public Standard_Transient {
	...
	:param reco:
	:type reco: Handle_IGESData_FileRecognizer &
	:rtype: None
") Add;
	...
	:param res:
	:type res: Handle_IGESData_IGESEntity &
	:rtype: bool
") Evaluate;
...
") Result;
		Handle_IGESData_IGESEntity Result ();
};
...
") DirChecker;
		virtual IGESData_DirChecker DirChecker (const Standard_Integer CN,const Handle_IGESData_IGESEntity & ent);
...
") NewVoid;
	...
	:rtype: void
") OwnCheckCase;
		virtual void OwnCheckCase (const Standard_Integer CN,const Handle_IGESData_IGESEntity & ent,const Interface_ShareTool & shares,Handle_Interface_Check & ach);
	...
	:type CN: int
	:param entfrom:
	:type entfrom: Handle_IGESData_IGESEntity &
	:param entto:
	:type entto: Handle_IGESData_IGESEntity &
	:param TC:
	:type TC: Interface_CopyTool &
	:rtype: void
") OwnCopyCase;
		virtual void OwnCopyCase (const Standard_Integer CN,const Handle_IGESData_IGESEntity & entfrom,const Handle_IGESData_IGESEntity & entto,Interface_CopyTool & TC);
	...
	:rtype: void
") OwnDeleteCase;
		virtual void OwnDeleteCase (const Standard_Integer CN,const Handle_IGESData_IGESEntity & ent);
	...
	:rtype: void
") OwnImpliedCase;
		virtual void OwnImpliedCase (const Standard_Integer CN,const Handle_IGESData_IGESEntity & ent,Interface_EntityIterator & iter);
	...
	:rtype: void
") OwnRenewCase;
		virtual void OwnRenewCase (const Standard_Integer CN,const Handle_IGESData_IGESEntity & entfrom,const Handle_IGESData_IGESEntity & entto,const Interface_CopyTool & TC);
	...
	:rtype: void
") OwnSharedCase;
		virtual void OwnSharedCase (const Standard_Integer CN,const Handle_IGESData_IGESEntity & ent,Interface_EntityIterator & iter);
...
class IGESData_GlobalNodeOfSpecificLib : public Standard_Transient {
	...
	:param amodule:
	:type amodule: Handle_IGESData_SpecificModule &
	:param aprotocol:
	:type aprotocol: Handle_IGESData_Protocol &
	:rtype: None
") Add;
...
") Module;
		Handle_IGESData_SpecificModule Module ();
...
") Next;
		Handle_IGESData_GlobalNodeOfSpecificLib Next ();
		%feature("compactdefaultargs") Protocol;
...
class IGESData_GlobalNodeOfWriterLib : public Standard_Transient {
	...
	:param amodule:
	:type amodule: Handle_IGESData_ReadWriteModule &
	:param aprotocol:
	:type aprotocol: Handle_IGESData_Protocol &
	:rtype: None
") Add;
...
") Module;
		Handle_IGESData_ReadWriteModule Module ();
		%feature("compactdefaultargs") Next;
		%feature("autodoc", "	* Returns the Next GlobalNode. If none is defined, returned value is a Null Handle

	:rtype: Handle_IGESData_GlobalNodeOfWriterLib
") Next;
		Handle_IGESData_GlobalNodeOfWriterLib Next ();
		%feature("compactdefaultargs") Protocol;
		%feature("autodoc", "	* Returns the attached Protocol stored in a given GlobalNode
...
") CopyRefs;
	...
	:rtype: Handle_TCollection_HAsciiString
") Date;
		Handle_TCollection_HAsciiString Date ();
...
") EndMark;
	...
	:rtype: Handle_TCollection_HAsciiString
") FileName;
		Handle_TCollection_HAsciiString FileName ();
...
") IGESVersion;
	...
	:param params:
	:type params: Handle_Interface_ParamSet &
	:param ach:
	:type ach: Handle_Interface_Check &
	:rtype: None
") Init;
...
") IntegerBits;
	...
	:rtype: Handle_TCollection_HAsciiString
") InterfaceVersion;
		Handle_TCollection_HAsciiString InterfaceVersion ();
	...
	:rtype: Handle_TCollection_HAsciiString
") LastChangeDate;
		Handle_TCollection_HAsciiString LastChangeDate ();
...
") NewDateString;
	...
	:param date:
	:type date: Handle_TCollection_HAsciiString &
	:param mode: default value is 1
	:type mode: int
	:rtype: Handle_TCollection_HAsciiString
") NewDateString;
...
") Scale;
	...
	:rtype: Handle_TCollection_HAsciiString
") SendName;
		Handle_TCollection_HAsciiString SendName ();
...
") SetUnitName;
	...
	:rtype: Handle_TCollection_HAsciiString
") SystemId;
		Handle_TCollection_HAsciiString SystemId ();
	...
	:param astr:
	:type astr: Handle_TCollection_HAsciiString &
	:rtype: Handle_TCollection_HAsciiString
") TranslatedFromHollerith;
		Handle_TCollection_HAsciiString TranslatedFromHollerith (const Handle_TCollection_HAsciiString & astr);
...
") UnitFlag;
	...
	:rtype: Handle_TCollection_HAsciiString
") UnitName;
		Handle_TCollection_HAsciiString UnitName ();
...
class IGESData_IGESDumper {
	...
	:rtype: None
") Dump;
		void Dump (const Handle_IGESData_IGESEntity & ent,const Handle_Message_Messenger & S,const Standard_Integer own,const Standard_Integer attached = -1);
...
") IGESData_IGESDumper;
	...
	:rtype: None
") OwnDump;
		void OwnDump (const Handle_IGESData_IGESEntity & ent,const Handle_Message_Messenger & S,const Standard_Integer own);
	...
	:rtype: None
") PrintDNum;
		void PrintDNum (const Handle_IGESData_IGESEntity & ent,const Handle_Message_Messenger & S);
	...
	:rtype: None
") PrintShort;
		void PrintShort (const Handle_IGESData_IGESEntity & ent,const Handle_Message_Messenger & S);
};
...
") ArePresentProperties;
	...
	:rtype: None
") Associate;
		void Associate (const Handle_IGESData_IGESEntity & ent);
...
") Color;
		Handle_IGESData_ColorEntity Color ();
...
") DefView;
	...
	:rtype: Handle_IGESData_IGESEntity
") DirFieldEntity;
		Handle_IGESData_IGESEntity DirFieldEntity (const Standard_Integer fieldnum);
	...
	:rtype: None
") Dissociate;
		void Dissociate (const Handle_IGESData_IGESEntity & ent);
...
") IGESType;
	...
	:param ent:
	:type ent: Handle_IGESData_ColorEntity &
...
") InitDirFieldEntity;
	...
	:param ent:
	:type ent: Handle_IGESData_LevelListEntity &
...
") InitLevel;
	...
	:param ent:
	:type ent: Handle_IGESData_LineFontEntity &
	:param rank: default value is 0
	:type rank: int
	:rtype: None
") InitLineFont;
	...
	:param str:
	:type str: Handle_IGESData_IGESEntity &
	:param lab:
	:type lab: Handle_IGESData_LabelDisplayEntity &
	:param weightnum:
	:type weightnum: int
	:rtype: None
") InitMisc;
...
") InitStatus;
	...
	:param ent:
	:type ent: Handle_IGESData_TransfEntity &
	:rtype: None
") InitTransf;
	...
	:param ent:
	:type ent: Handle_IGESData_ViewKindEntity &
	:rtype: None
") InitView;
...
") LabelDisplay;
		Handle_IGESData_LabelDisplayEntity LabelDisplay ();
...
") LevelList;
		Handle_IGESData_LevelListEntity LevelList ();
		%feature("compactdefaultargs") LineFont;
...
") LineFont;
		Handle_IGESData_LineFontEntity LineFont ();
		%feature("compactdefaultargs") LineWeight;
...
") Location;
	...
	:rtype: Handle_TCollection_HAsciiString
") NameValue;
		Handle_TCollection_HAsciiString NameValue ();
...
") NbTypedAssociativities;
		Standard_Integer NbTypedAssociativities (const Handle_Standard_Type & atype);
	...
	:rtype: int
") NbTypedProperties;
		Standard_Integer NbTypedProperties (const Handle_Standard_Type & atype);
...
") RemoveProperty;
	...
	:rtype: None
") SetLabel;
		void SetLabel (const Handle_TCollection_HAsciiString & label,const Standard_Integer sub = -1);
...
") SetLineWeight;
	...
	:rtype: Handle_TCollection_HAsciiString
") ShortLabel;
		Handle_TCollection_HAsciiString ShortLabel ();
...
") SingleView;
		Handle_IGESData_ViewKindEntity SingleView ();
		%feature("compactdefaultargs") Structure;
	...
	:rtype: Handle_IGESData_IGESEntity
") Structure;
		Handle_IGESData_IGESEntity Structure ();
...
") Transf;
		Handle_IGESData_TransfEntity Transf ();
...
") TypeNumber;
	...
	:rtype: Handle_IGESData_IGESEntity
") TypedAssociativity;
		Handle_IGESData_IGESEntity TypedAssociativity (const Handle_Standard_Type & atype);
	...
	:rtype: Handle_IGESData_IGESEntity
") TypedProperty;
		Handle_IGESData_IGESEntity TypedProperty (const Handle_Standard_Type & atype,const Standard_Integer anum = 0);
	...
	:rtype: Handle_IGESData_IGESEntity
") UniqueParent;
		Handle_IGESData_IGESEntity UniqueParent ();
...
") VectorLocation;
	...
	:rtype: Handle_IGESData_ViewKindEntity
") View;
		Handle_IGESData_ViewKindEntity View ();
	...
	:rtype: Handle_IGESData_ViewKindEntity
") ViewList;
		Handle_IGESData_ViewKindEntity ViewList ();
};
...
") ClearStartSection;
	...
	:rtype: int
") DNum;
		Standard_Integer DNum (const Handle_IGESData_IGESEntity & ent);
...
") NewEmptyModel;
	...
	:rtype: None
") PrintInfo;
		void PrintInfo (const Handle_Standard_Transient & ent,const Handle_Message_Messenger & S);
...
") SetLineWeights;
	...
	:rtype: None
") SetStartSection;
		void SetStartSection (const Handle_TColStd_HSequenceOfHAsciiString & list,const Standard_Boolean copy = Standard_True);
...
") StartSection;
		Handle_TColStd_HSequenceOfHAsciiString StartSection ();
...
") GlobalCheck;
		Handle_Interface_Check GlobalCheck ();
		%feature("compactdefaultargs") GlobalSection;
...
") EndRead;
	...
	:param reader:
	:type reader: Handle_IGESData_IGESReaderData &
	:param protocol:
	:type protocol: Handle_IGESData_Protocol &
	:rtype: None
...
") Prepare;
	...
	:type ent: Handle_IGESData_IGESEntity &
	:param IR:
	:type IR: Handle_IGESData_IGESReaderData &
	:param PR:
	:type PR: IGESData_ParamReader &
	:rtype: None
") ReadAssocs;
		void ReadAssocs (const Handle_IGESData_IGESEntity & ent,const Handle_IGESData_IGESReaderData & IR,IGESData_ParamReader & PR);
	...
	:rtype: None
") ReadDir;
		void ReadDir (const Handle_IGESData_IGESEntity & ent,const Handle_IGESData_IGESReaderData & IR,const IGESData_DirPart & DP,Handle_Interface_Check & ach);
	...
	:rtype: None
") ReadOwnParams;
		void ReadOwnParams (const Handle_IGESData_IGESEntity & ent,const Handle_IGESData_IGESReaderData & IR,IGESData_ParamReader & PR);
	...
	:rtype: None
") ReadProps;
		void ReadProps (const Handle_IGESData_IGESEntity & ent,const Handle_IGESData_IGESReaderData & IR,IGESData_ParamReader & PR);
...
class IGESData_IGESWriter {
	...
	:param anent:
	:type anent: Handle_IGESData_IGESEntity &
	:rtype: None
") Associativities;
...
") FloatWriter;
	...
	:param amodel:
	:type amodel: Handle_IGESData_IGESModel &
	:rtype: None
") IGESData_IGESWriter;
...
") SectionS;
	...
	:rtype: Handle_TColStd_HSequenceOfHAsciiString
") SectionStrings;
		Handle_TColStd_HSequenceOfHAsciiString SectionStrings (const Standard_Integer numsec);
...
class IGESData_NodeOfSpecificLib : public Standard_Transient {
	...
	:param anode:
	:type anode: Handle_IGESData_GlobalNodeOfSpecificLib &
	:rtype: None
") AddNode;
...
") Next;
		Handle_IGESData_NodeOfSpecificLib Next ();
		%feature("compactdefaultargs") Protocol;
...
class IGESData_NodeOfWriterLib : public Standard_Transient {
	...
	:param anode:
	:type anode: Handle_IGESData_GlobalNodeOfWriterLib &
	:rtype: None
") AddNode;
...
") Next;
		Handle_IGESData_NodeOfWriterLib Next ();
		%feature("compactdefaultargs") Protocol;
		%feature("autodoc", "	* Returns the Protocol designated by a precise Node
...
") AddFail;
	...
	:param af:
	:type af: Handle_TCollection_HAsciiString &
	:param bf:
	:type bf: Handle_TCollection_HAsciiString &
	:rtype: None
") AddFail;
...
") AddWarning;
	...
	:param aw:
	:type aw: Handle_TCollection_HAsciiString &
	:param bw:
	:type bw: Handle_TCollection_HAsciiString &
	:rtype: None
") AddWarning;
...
") HasFailed;
	...
	:param list:
	:type list: Handle_Interface_ParamList &
	:param ach:
	:type ach: Handle_Interface_Check &
...
") ReadBoolean;
	...
	:rtype: bool
") ReadEntList;
		Standard_Boolean ReadEntList (const Handle_IGESData_IGESReaderData & IR,const IGESData_ParamCursor & PC,Message_Msg & amsg,Interface_EntityList & val,const Standard_Boolean ord = Standard_True);
		%feature("compactdefaultargs") ReadEntList;
	...
	:rtype: bool
") ReadEntList;
		Standard_Boolean ReadEntList (const Handle_IGESData_IGESReaderData & IR,const IGESData_ParamCursor & PC,const char * mess,Interface_EntityList & val,const Standard_Boolean ord = Standard_True);
	...
	:type amsg: Message_Msg &
	:param val:
	:type val: Handle_IGESData_HArray1OfIGESEntity &
...
") ReadInteger;
	...
	:type amsg: Message_Msg &
	:param val:
	:type val: Handle_TColStd_HArray1OfInteger &
	:param index: default value is 1
	:type index: int
	:rtype: bool
") ReadInts;
...
") ReadReal;
	...
	:type amsg: Message_Msg &
	:param val:
	:type val: Handle_TColStd_HArray1OfReal &
	:param index: default value is 1
	:type index: int
	:rtype: bool
") ReadReals;
...
") ReadText;
	...
	:type amsg: Message_Msg &
	:param val:
	:type val: Handle_Interface_HArray1OfHAsciiString &
	:param index: default value is 1
	:type index: int
	:rtype: bool
") ReadTexts;
...
") Read;
	...
	:rtype: void
") ReadOwnParams;
		virtual void ReadOwnParams (const Standard_Integer CN,const Handle_IGESData_IGESEntity & ent,const Handle_IGESData_IGESReaderData & IR,IGESData_ParamReader & PR);
	...
	:rtype: void
") WriteOwnParams;
		virtual void WriteOwnParams (const Standard_Integer CN,const Handle_IGESData_IGESEntity & ent,IGESData_IGESWriter & IW);
};
...
") Protocol;
	...
	:param obj:
	:type obj: Handle_IGESData_IGESEntity &
	:param module:
	:type module: Handle_IGESData_SpecificModule &
	:param CN:
	:type CN: int &
	:rtype: bool
") Select;
		Standard_Boolean Select (const Handle_IGESData_IGESEntity & obj,Handle_IGESData_SpecificModule & module,Standard_Integer &OutValue);
...
class IGESData_SpecificModule : public Standard_Transient {
	...
	:rtype: bool
") OwnCorrect;
		virtual Standard_Boolean OwnCorrect (const Standard_Integer CN,const Handle_IGESData_IGESEntity & ent);
		%feature("compactdefaultargs") OwnDump;
	...
	:rtype: void
") OwnDump;
		virtual void OwnDump (const Standard_Integer CN,const Handle_IGESData_IGESEntity & ent,const IGESData_IGESDumper & dumper,const Handle_Message_Messenger & S,const Standard_Integer own);
};
...
") ConvertLocation;
	...
	:rtype: gp_GTrsf
") EffectiveLocation;
		gp_GTrsf EffectiveLocation (const Handle_IGESData_IGESEntity & ent);
	...
	:rtype: gp_GTrsf
") ExplicitLocation;
		gp_GTrsf ExplicitLocation (const Handle_IGESData_IGESEntity & ent);
	...
	:rtype: bool
") HasParent;
		Standard_Boolean HasParent (const Handle_IGESData_IGESEntity & ent);
...
") HasParentByAssociativity;
		Standard_Boolean HasParentByAssociativity (const Handle_IGESData_IGESEntity & ent);
		%feature("compactdefaultargs") HasTransf;
	...
	:rtype: bool
") HasTransf;
		Standard_Boolean HasTransf (const Handle_IGESData_IGESEntity & ent);
...
") IGESData_ToolLocation;
	...
	:rtype: bool
") IsAmbiguous;
		Standard_Boolean IsAmbiguous (const Handle_IGESData_IGESEntity & ent);
	...
	:rtype: bool
") IsAssociativity;
		Standard_Boolean IsAssociativity (const Handle_IGESData_IGESEntity & ent);
	...
	:rtype: bool
") IsTransf;
		Standard_Boolean IsTransf (const Handle_IGESData_IGESEntity & ent);
...
") Load;
	...
	:rtype: Handle_IGESData_IGESEntity
") Parent;
		Handle_IGESData_IGESEntity Parent (const Handle_IGESData_IGESEntity & ent);
...
") SetOwnAsDependent;
	...
	:param parent:
	:type parent: Handle_IGESData_IGESEntity &
	:param child:
	:type child: Handle_IGESData_IGESEntity &
	:rtype: None
") SetParentAssoc;
...
") Protocol;
	...
	:type obj: Handle_IGESData_IGESEntity &
	:param module:
	:type module: Handle_IGESData_ReadWriteModule &
	:param CN:
	:type CN: int &
	:rtype: bool
") Select;
		Standard_Boolean Select (const Handle_IGESData_IGESEntity & obj,Handle_IGESData_ReadWriteModule & module,Standard_Integer &OutValue);
		%feature("compactdefaultargs") SetComplete;
		%feature("autodoc", "	* Sets a library to be defined with the complete Global list (all the couples Protocol/Modules recorded in it)
...
class IGESData_DefaultGeneral : public IGESData_GeneralModule {
	...
	:rtype: IGESData_DirChecker
") DirChecker;
		IGESData_DirChecker DirChecker (const Standard_Integer CN,const Handle_IGESData_IGESEntity & ent);
...
") NewVoid;
	...
	:rtype: None
") OwnCheckCase;
		void OwnCheckCase (const Standard_Integer CN,const Handle_IGESData_IGESEntity & ent,const Interface_ShareTool & shares,Handle_Interface_Check & ach);
		%feature("compactdefaultargs") OwnCopyCase;
		%feature("autodoc", "	* Copies parameters which are specific of each Type of Entity
	...
	:rtype: None
") OwnCopyCase;
		void OwnCopyCase (const Standard_Integer CN,const Handle_IGESData_IGESEntity & entfrom,const Handle_IGESData_IGESEntity & entto,Interface_CopyTool & TC);
		%feature("compactdefaultargs") OwnSharedCase;
	...
	:rtype: None
") OwnSharedCase;
		void OwnSharedCase (const Standard_Integer CN,const Handle_IGESData_IGESEntity & ent,Interface_EntityIterator & iter);
};
...
") IGESData_DefaultSpecific;
	...
	:rtype: None
") OwnDump;
		void OwnDump (const Standard_Integer CN,const Handle_IGESData_IGESEntity & ent,const IGESData_IGESDumper & dumper,const Handle_Message_Messenger & S,const Standard_Integer own);
};
...
class IGESData_NameEntity : public IGESData_IGESEntity {
	...
	:rtype: Handle_TCollection_HAsciiString
") Value;
		virtual Handle_TCollection_HAsciiString Value ();
};
...
class IGESData_SingleParentEntity : public IGESData_IGESEntity {
	...
	:rtype: Handle_IGESData_IGESEntity
") Child;
		virtual Handle_IGESData_IGESEntity Child (const Standard_Integer num);
...
") NbChildren;
	...
	:rtype: Handle_IGESData_IGESEntity
") SingleParent;
		virtual Handle_IGESData_IGESEntity SingleParent ();
};
...
") ReadOwnParams;
	...
	:param cont:
	:type cont: Handle_Interface_UndefinedContent &
	:rtype: None
") SetNewContent;
...
") SetOKDirPart;
	...
	:rtype: Handle_Interface_UndefinedContent
") UndefinedContent;
		Handle_Interface_UndefinedContent UndefinedContent ();
		%feature("compactdefaultargs") WriteOwnParams;
...
") NbViews;
	...
	:rtype: Handle_IGESData_ViewKindEntity
") ViewItem;
		virtual Handle_IGESData_ViewKindEntity ViewItem (const Standard_Integer num);
};
...
class IGESData_FreeFormatEntity : public IGESData_UndefinedEntity {
	...
	:param ents:
	:type ents: Handle_IGESData_HArray1OfIGESEntity &
	:rtype: None
") AddEntities;
	...
	:rtype: None
") AddEntity;
		void AddEntity (const Interface_ParamType ptype,const Handle_IGESData_IGESEntity & ent,const Standard_Boolean negative = Standard_False);
...
") NegativePointers;
		Handle_TColStd_HSequenceOfInteger NegativePointers ();
	...
	:rtype: bool
") ParamData;
		Standard_Boolean ParamData (const Standard_Integer num,Interface_ParamType & ptype,Handle_IGESData_IGESEntity & ent,Handle_TCollection_HAsciiString & val);
		%feature("compactdefaultargs") ParamEntity;
	...
	:rtype: Handle_IGESData_IGESEntity
") ParamEntity;
		Handle_IGESData_IGESEntity ParamEntity (const Standard_Integer num);
		%feature("compactdefaultargs") ParamType;
