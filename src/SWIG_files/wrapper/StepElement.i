...
%extend NCollection_Array1 <Handle_StepElement_CurveElementSectionDefinition> {
    %pythoncode {
...
%extend NCollection_Array1 <Handle_StepElement_HSequenceOfCurveElementPurposeMember> {
    %pythoncode {
    def __getitem__(self, index):
        if index + self.Lower() > self.Upper():
            raise IndexError("index out of range")
...
%extend NCollection_Array1 <Handle_StepElement_CurveElementEndReleasePacket> {
    %pythoncode {
    def __getitem__(self, index):
        if index + self.Lower() > self.Upper():
            raise IndexError("index out of range")
...
%extend NCollection_Array1 <Handle_StepElement_SurfaceSection> {
    %pythoncode {
    def __getitem__(self, index):
        if index + self.Lower() > self.Upper():
            raise IndexError("index out of range")
...
%extend NCollection_Array1 <Handle_StepElement_HSequenceOfSurfaceElementPurposeMember> {
    %pythoncode {
    def __getitem__(self, index):
        if index + self.Lower() > self.Upper():
            raise IndexError("index out of range")
...
%extend NCollection_Array1 <Handle_StepElement_VolumeElementPurposeMember> {
    %pythoncode {
    def __getitem__(self, index):
        if index + self.Lower() > self.Upper():
            raise IndexError("index out of range")
