...
%define Handle_SelectMgr_SensitiveEntitySet Handle(SelectMgr_SensitiveEntitySet)
%enddef
typedef SelectMgr_SensitiveEntitySet  BVH_PrimitiveSet3d;
%define Handle_SelectMgr_BaseFrustum Handle(SelectMgr_BaseFrustum)
%enddef
typedef SelectMgr_BaseFrustum Standard_Transient;
