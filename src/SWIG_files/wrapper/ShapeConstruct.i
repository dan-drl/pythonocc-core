...
") Init;
	...
	:rtype: bool
") Perform;
		virtual Standard_Boolean Perform (Handle_Geom_Curve & c3d,const Standard_Real First,const Standard_Real Last,Handle_Geom2d_Curve & c2d,const Standard_Real TolFirst = -1,const Standard_Real TolLast = -1);
